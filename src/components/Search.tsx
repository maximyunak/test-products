  ...
  return (
    <div className="">
      <input
        ...
        className="transition border-gray-600 placeholder-gray-400 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-56 px-2.5 py-2 text-sm max-[400px]:w-full"
